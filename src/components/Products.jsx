    ...
    return (
      <>
        <div className="buttons d-flex justify-content-center mb-5 pb-5">
          ...
          <button className="btn btn-outline-dark me-2" onClick={()=>filterProduct("men's clothing")}>Kid's</button>
      ...
      <div className="container my-5 py-5">
        <div className="row">
          <div className="col-12 mb-5">
            <h4 className="display-6 fw-bolder text-center">New Product</h4>
            <hr />
          </div>
        </div>
